...
const typeLocations = {
	...
	meta: {
		messages: {
			interface:
				'Exported interfaces should live in types.ts, *.types.ts, or a types/ directory.',
			type: 'Exported type aliases should live in types.ts, *.types.ts, or a types/ directory.',
		},
		type: 'suggestion',
	},
}
